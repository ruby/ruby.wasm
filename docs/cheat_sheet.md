...
```html
<html>
  <script src="https://cdn.jsdelivr.net/npm/@ruby/4.0-wasm-wasi@2.8.0/dist/browser.script.iife.js"></script>
...
<html>
  <script type="module">
    ...
    const response = await fetch("https://cdn.jsdelivr.net/npm/@ruby/4.0-wasm-wasi@2.8.0/dist/ruby+stdlib.wasm");
