...
```html
<html>
  <script src="https://cdn.jsdelivr.net/npm/@ruby/4.0-wasm-wasi@2.9.1/dist/browser.script.iife.js"></script>
...
<html>
  <script type="module">
    import { DefaultRubyVM } from "https://cdn.jsdelivr.net/npm/@ruby/wasm-wasi@2.9.1/dist/browser/+esm";
    const response = await fetch("https://cdn.jsdelivr.net/npm/@ruby/4.0-wasm-wasi@2.9.1/dist/ruby+stdlib.wasm");
...
```html
<html>
  <script src="https://cdn.jsdelivr.net/npm/@ruby/wasm-wasi@2.9.1/dist/browser.umd.js"></script>
  <script>
    const main = async () => {
